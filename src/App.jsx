  ...
  if (pookachu.wantsToMove) {
    setPookachu((prevPookachu) => {
      ...
      switch (prevPookachu.direction) {
        case 'right':
          newXPosition = Math.min(prevPookachu.xPosition + 1, boundaries.xAxis.max)
          break
        case 'left':
          newXPosition = Math.max(prevPookachu.xPosition - 1, boundaries.xAxis.min)
          break
        case 'down':
          newYPosition = Math.min(prevPookachu.yPosition + 1, boundaries.yAxis.max)
          break
        case 'up':
          newYPosition = Math.max(prevPookachu.yPosition - 1, boundaries.yAxis.min)
          break
        default:
          break
      }
      ...
      if (newXPosition !== prevPookachu.xPosition || newYPosition !== prevPookachu.yPosition) {
        return {
          ...prevPookachu,
